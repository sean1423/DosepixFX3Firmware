/*
 * Project Name: continuous_read_write.cyfx
 * Time : 07/18/2016 14:35:31
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_CONTINUOUS_READ_WRITE_CYDSN_
#define _INCLUDED_CONTINUOUS_READ_WRITE_CYDSN_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    ...
    {{0x2E739A02,0x04000100,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x2E739A03,0x20000000,0x80000000},{0x00000000,0x00000000,0x00000000}}
};
...
uint32_t CyFxGpifRegValue[]  = {
    0x8000C3B0,  /*  CY_U3P_PIB_GPIF_CONFIG */
    ...
    0x00001F87,  /*  CY_U3P_PIB_GPIF_SERIAL_OUT_CONFIG */
...
#endif   /* _INCLUDED_CONTINUOUS_READ_WRITE_CYDSN_ */
