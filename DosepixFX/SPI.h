...
#define FX3_SPI_CLK             (41) /* GPIO Id 53 will be used for providing SPI Clock */
#define FX3_SPI_SS              (42) /* GPIO Id 54 will be used as slave select line */
#define FX3_SPI_MISO            (43) /* GPIO Id 55 will be used as MISO line */
#define FX3_SPI_MOSI            (44) /* GPIO Id 56 will be used as MOSI line */
